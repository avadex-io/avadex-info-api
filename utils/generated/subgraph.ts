...
export type PairQuery = (
  ...
  & { readonly pair?: Maybe<(
    { readonly __typename?: 'Pair' }
  & Pick<Pair, 'id' | 'volumeToken0' | 'volumeToken1' | 'reserveUSD' | 'reserveBNB' | 'token0' | 'token1' | 'reserve0' | 'reserve1' | 'token0Price' | 'token1Price'>
    & { readonly token0: (
      { readonly __typename?: 'Token' }
      & TokenInfoFragment
    ), readonly token1: (
...
// export type TvlQuery = (
//   { readonly __typename?: 'Query' }
//   & { readonly tvl?: Maybe<(
//     { readonly __typename?: 'Tvl' }
//     & Pick<Tvl, 'id' | 'totalLiquidityUSD' >
//   )> }
// );
...
export type TvlQueryVariables = Exact<{
  limit: Scalars['Int'];
}>;
...
export type TopTransactionsQuery = (
  { readonly __typename?: 'Query' }
